        ...
        <header>
            <div className="relative w-40 h-40 overflow-hidden rounded-full mb-4">
                <Image
                    ...
                    alt="Joaquin Pacia headshot"
                    className="w-full -translate-y-1/6"
                    width={320}
                    height={480}
                    sizes="160px"
                    priority
            ...
            >
                <span aria-hidden="true">📍</span> Mississauga, ON, Canada{" "}
            ...
            <div className="mt-6 flex space-x-3 items-center">
                <a
                    href="resume/Joaquin Pacia Resume 2025.pdf"
                    download
                    style={{
                        background: "var(--color-ink)",
                        color: "var(--color-paper)",
                    }}
                    className="flex items-center px-4 py-2.5 rounded transition-colors duration-200 mr-4 hover:[background:var(--color-graphite)]"
                >
                    <svg
                        stroke="currentColor"
                        fill="currentColor"
                ...
                <a
                    ...
                    style={{ color: "var(--color-graphite)" }}
                    className="transition-colors duration-200 hover:[color:var(--color-ink)]"
