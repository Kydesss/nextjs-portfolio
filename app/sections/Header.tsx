...
export default function Header() {
    return (
        <header>
            ...
            <h1 className="mb-2 dark:text-white text-4xl font-bold">
                Joaquin Paolo Pacia
            </h1>
            <h2 className="text-xl dark:text-gray-400 mb-4">Multimedia Producer</h2>
            <h3 className="text-lg dark:text-gray-400 mb-4">
                📍 Mississauga, ON, Canada 🇨🇦
            </h3>
            <p className="dark:text-gray-300 text-sm">Fun is equal to success.</p>
